...
public class Constants {
	//(key from sdk)public static final String BingMapsKey = "AkrQHLDk6bferFwpfke6DXGBz9fC1Jyog-jiBBwWblAmcwfQHPQqMt1TcgALnAYY";
	public static final String BingMapsKey = "Ah4cXWbscRjMDTq2U13FgqKmce9mkz_fxnJZUZ8aLmar2Gd_OnX58mJWtgyfbnc3";
	...
	public static class TileLayers{
		public static final String Tile = "route";

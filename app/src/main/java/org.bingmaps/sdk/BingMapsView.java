...
public class BingMapsView extends WebView {
    ...
    private final boolean mDragging = false;
    ...
    public void injectJavaScript(final String js) {
        ...
        this.post(() -> BingMapsView.this.loadUrl("javascript:(function() { " + js + " })();"));
    }
    ...
    private void initialize() {
        ...
        BingMapsJavaScriptInterface _JSInterface = new BingMapsJavaScriptInterface();
    ...
    final class BingMapsJavaScriptInterface {
        ...
        @JavascriptInterface
        public void mapLoaded() throws JSONException {

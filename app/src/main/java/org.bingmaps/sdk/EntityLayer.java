...
public class EntityLayer extends BaseLayer {
	...
	private final Map<String, HashMap<String, Object>> _metadata;
	private final List<BaseEntity> _pendingEntities;
	...
	public EntityLayer(String layerName){
		...
		_pendingEntities = new ArrayList<>();
	}
	...
	public String toString(){
		...
		if(_pendingEntities.size() > 0){
			sb.append("{LayerName:'").append(this.getLayerName()).append("',Entities:[");

...
public class LayerManager {
    ...
    private final BingMapsView _map;
    private final Hashtable<String, BaseLayer> _layers;
    ...
    void addLayer(BaseLayer layer) {
        ...
        _map.injectJavaScript("BingMapsAndroid.AddLayer(" + layer + ");");
    }

    public void addLayer(TileLayer layer) {
        layer.setBingMapsView(_map);
        _layers.put(layer.getLayerName(), layer);
        _map.injectJavaScript("BingMapsAndroid.InsertLayer(" + layer + ");");
    }
